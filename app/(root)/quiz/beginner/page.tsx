...
import { multipleQuizBeginner } from "@/constants/multiplechoice"
...
export default function Page() {
    ...
    const [questions, setQuestions] = useState(multipleQuizBeginner.questions);
    ...
    // const { questions } = multipleQuizBeginner;
